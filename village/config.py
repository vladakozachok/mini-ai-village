...
def build_prompt(agent_name: str) -> str:
    return (
        ...
        "MEMORY: If you are waiting, include the specific agent name you need in NEEDS and what you need them to do.\n"
        ...
        "ELEMENTS: Try to note the exact elements and click_element or click_index rather than click_relative. Note your page orientation. If the page requests an action from you, make sure to consider this in your decision-making process.\n"
